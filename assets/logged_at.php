                                ...
                                <form class="join j-join">  
                                    <div class="join__body"  >
                                        <div class="join__row" style="visibility:hidden">
                                            <input type="text" class="join__input" id="usertype" name="username" value="Atendente" >
                                        </div>
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default j-decline">Recusar</button>
...
<!-- TEMPLATES -->
    ...
    <script type="text/template" id="dashboard_tpl">
        ...
        <!--<label class="switch">
            <input class="ocupado" type="checkbox">
            <div class="slider round"></div>
        </label>-->

        <div class="state_board j-state_board">   
