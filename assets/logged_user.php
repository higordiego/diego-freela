            ...
            <!--div class="content-wrapper"-->
                        <div class="wrapper j-wrapper">      
                            ...
                            <main class="app" id="app">
                                ...
                                <form class="join j-join" id="form">  
                                    <div class="join__body"  >
                                        <div class="join__row" style="visibility:hidden">
                                            <input type="text" class="join__input" id="usertype" name="username" value="Cliente" >
                                        </div>

                                        <div class="join__row" style="visibility:hidden">
                                            <input type="text" class="join__input" name="room" value="testroom">
                                        </div>

                                        <div class="join__row">
                                            <button type="submit" class="join__btn">Entrar</button>
                                        </div>
                                    </div>
                                </form>                  
                            ...
                            <audio id="callingSignal" loop preload="auto">
                                <source src="./assets/audio/calling.ogg"></source>
                                <source src="./assets/audio/calling.mp3"></source>
                            </audio>

                            <audio id="ringtoneSignal" loop preload="auto">
                                <source src="./assets/audio/ringtone.ogg"></source>
                                <source src="./assets/audio/ringtone.mp3"></source>
                            </audio>

                            <audio id="endCallSignal" preload="auto">
                                <source src="./assets/audio/end_of_call.ogg"></source>
                                <source src="./assets/audio/end_of_call.mp3"></source>
                            </audio>
                        </div>
                        <!-- MODALS -->
                        <div class="modal fade" id="waiting_queue" tabindex="-1" data-backdrop="static" data-keyboard="false">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        
                                        <h4>Aguarde o atendimento</h4>
                                    </div>

                                    <div class="modal-body">
                                        <p class="text-danger" id="textfila">
                        ...
                        <div class="modal fade" id="connect_err" tabindex="-1" data-backdrop="static" data-keyboard="false">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="text-danger">
                                            Verifique a conexão com a internet em tente novamente.
                                        </p>
                                    </div>
                                    <p></p>
                                </div>
                        ...
                        <div class="modal fade" id="already_auth" tabindex="-1">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="text-danger">Usuário já foi autenticado.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="error_no_calles" tabindex="-1">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="text-danger">Selecione usuário para ligar</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default j-decline">Rejeitar</button>
                                        <button type="button" class="btn btn-primary j-accept">Aceitar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- TEMPLATES -->
        ...
        <script type="text/template" id="tpl_device_not_found">
            Erro: Camera ou microfone não encontrados.
            <span class="qb-text">Login in <b>as <%=name%></b></span>
            <button class='fw-link j-logout'>Desconectar</button>
        </script>
    ...
    <script type="text/template" id="frames_tpl">
        ...
        <div class="caller">
            ...
            <div class="caller__ctrl">
                <button class="caller__ctrl_btn j-actions" id="btnOnOff"></button>
            </div>
    ...
    <script src="./assets/js/stateBoard.js"></script>
